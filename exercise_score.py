...
class ExerciseScore:
    ...
    def __init__(self, per_week, height, weight):
        self.prev_week = [0]*7
        ...
        self.exercises = ['Running', 'Cycling', 'Weights', 'Swimming', 'Walking']
        self.update_score()
    ...
    def exercise_recommendation(self):
        ...
        if self.last_exercise in exercises:
            exercises.remove(self.last_exercise)
    ...
    def days_since_last_workout(self):
...
##per_week = 6
##
##user = ExerciseScore(per_week,h,w)
##print(user.score)
##user.add_exercise(0)
##print(user.score)
##user.add_exercise(0)
...
##print(user.score)
##print(user.exercise_recommendation())
##user.add_exercise('Cycling')
##print(user.days_since_last_workout())
